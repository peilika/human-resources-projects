...
{
	public class IsUpdateAndOldHFDs
	{
		...
		public string OldFirstKindId {  get; set; }
		public string OldSecondKindId { get; set; }
		public string OldThirdKindId { get; set; }
		public string OldSalaryStandardId { get; set; }
	}
}
